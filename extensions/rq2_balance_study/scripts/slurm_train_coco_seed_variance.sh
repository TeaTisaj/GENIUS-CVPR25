#!/bin/bash
#SBATCH --job-name=genius-coco-stage2-seedvar
#SBATCH --output=/home/tcetoje/logs/genius_coco_stage2_seedvar_%j.log
#SBATCH --error=/home/tcetoje/logs/genius_coco_stage2_seedvar_%j.log
