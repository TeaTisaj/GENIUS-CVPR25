#!/bin/bash
#SBATCH --job-name=genius-eval-coco-seed-variance
#SBATCH --output=/home/tcetoje/logs/genius_eval_coco_seed_variance_%j.log
#SBATCH --error=/home/tcetoje/logs/genius_eval_coco_seed_variance_%j.log
