#!/bin/bash
#SBATCH --job-name=genius-feat-cirr
#SBATCH --output=/home/tcetoje/logs/genius_feat_cirr_%j.log
#SBATCH --error=/home/tcetoje/logs/genius_feat_cirr_%j.log
...
CONFIG_PATH="$MODEL_DIR/config_cand_cirr.yaml"
NPROC=4
...
echo "Done. Embeddings saved to: $GENIR_DIR/extracted_embed/CLIP_SF/cand/cand_pool_cirr_task7_IT_dict.pt"
