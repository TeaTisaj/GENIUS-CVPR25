#!/bin/bash
#SBATCH --job-name=genius-feat-nights
#SBATCH --output=/home/tcetoje/logs/genius_feat_nights_%j.log
#SBATCH --error=/home/tcetoje/logs/genius_feat_nights_%j.log
...
CONFIG_PATH="$MODEL_DIR/config_cand_nights.yaml"
NPROC=4
...
echo "Done. Embeddings saved to: $GENIR_DIR/extracted_embed/CLIP_SF/cand/cand_pool_nights_task4_IT_dict.pt"
